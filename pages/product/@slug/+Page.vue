<template>
  ...
  <div style="
    min-height: 100vh;
    background-image: url('https://img.xqdj.site/xiazai/shouyedatu');
  ...
  ">
    ...
    <div v-else class="grid gap-6 lg:grid-cols-[2fr_1fr]">
      <section class="card bg-base-100/85 shadow-sm overflow-hidden">
        ...
        <div class="card-body space-y-4">
          ...
          ></div>
          <div class="rounded-box bg-base-200/85 p-4 text-sm text-base-content/80">
            {{ product.purchaseNote || '下单后将生成待支付订单，支付成功后会给您的联系邮箱发送通知，请注意查看。' }}
          </div>
        </div>
      </section>
      <aside>
        <div class="lg:sticky lg:top-24 card bg-base-100/85 shadow-sm">
          <div class="card-body space-y-4">
            <div>
...
张三，13812341234，广东省深圳市xxx"></textarea>
            ...
            <div v-if="discountPreview.valid" class="rounded-box bg-base-200/85 p-4 space-y-2">
